...
namespace eval ::optrace {
  variable script "/HDD/CollegeWork/dsf/proj_cordic/proj_cordic.runs/impl_1/toplevel.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet /HDD/CollegeWork/dsf/proj_cordic/proj_cordic.runs/synth_1/toplevel.dcp
