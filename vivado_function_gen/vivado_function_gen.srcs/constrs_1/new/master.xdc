...
# Clock signal
set_property PACKAGE_PIN W5 [get_ports clk_inp]							
	set_property IOSTANDARD LVCMOS33 [get_ports clk_inp]
	create_clock -add -name sys_clk_inp_pin -period 10.00 -waveform {0 5} [get_ports clk_inp]
...
##USB HID (PS/2)
#set_property PACKAGE_PIN C17 [get_ports PS2clk_inp]						
	#set_property IOSTANDARD LVCMOS33 [get_ports PS2clk_inp]
	#set_property PULLUP true [get_ports PS2clk_inp]
...
##Quad SPI Flash
##Note that Cclk_inp_0 cannot be placed in 7 series devices. You can access it using the
##STARTUPE2 primitive.
